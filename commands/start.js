        ...
        if(env.keyv.get("locked") === true) {
            ...
            for(var world of env.worlds) {
                if(interaction.guild.id === world.guildID) {
                    ...
                    env.logger.verbose(`Start command came from server ${world.guildName}`);
            ...
            child.on("exit", async function () {
                ...
                await interaction.followUp({ content: "Server has completed startup! You can connect now. :partying_face:", ephemeral: true });
